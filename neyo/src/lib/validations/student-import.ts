...
export const IMPORT_FIELDS = [
  ...
  "admissionNo", // OPTIONAL existing school number; kept if unused, else auto
  "upiNumber",
  "birthCertNo",
  "guardianName",
  "guardianPhone",
...
export const HEADER_SYNONYMS: Record<Exclude<ImportField, "ignore">, string[]> = {
  ...
  admissionNo: ["admissionno", "admno", "admissionnumber", "adm", "admission", "regno", "registrationno", "nambari"],
