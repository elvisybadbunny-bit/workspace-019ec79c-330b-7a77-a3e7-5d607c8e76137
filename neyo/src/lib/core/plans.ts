 ...
 * - hard usage limits (students/staff/SMS) with soft-overage allowances
 ...
 * - addOns the school can buy à la carte (priced per term)
...
export const ADD_ONS: AddOnDef[] = [
  { key: "sms_topup_1000", name: "SMS top-up (1,000)", pricePerTerm: 800, description: "1,000 extra SMS this term." },
...
export const PLANS: PlanDef[] = [
  {
    ...
    pricePerTerm: 0,
    perStudentPerTerm: 0,
    limits: { students: 50, staff: 10, smsPerTerm: 200 },
  ...
  },
  {
    ...
    pricePerTerm: 4500,
    perStudentPerTerm: 0,
    limits: { students: 250, staff: 35, smsPerTerm: 2000 },
  ...
  },
  {
    ...
    pricePerTerm: 9000,
    perStudentPerTerm: 0,
    limits: { students: 600, staff: 80, smsPerTerm: 5000 },
  ...
  },
  {
    ...
    pricePerTerm: 22000,
    perStudentPerTerm: 0,
    limits: { students: 5000, staff: 500, smsPerTerm: 30000 },
