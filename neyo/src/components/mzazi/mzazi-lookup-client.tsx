      ...
      <div className="w-full max-w-sm rounded-2xl border border-navy-100 bg-white p-7 shadow-card dark:border-navy-800 dark:bg-navy-900">
        ...
        {res?.ok ? (
          <div className="text-center">
            ...
            {(res.balanceKes ?? 0) > 0 && (
              <div className="mt-4 rounded-xl border border-green-200 bg-green-50/60 p-4 text-left dark:border-green-900 dark:bg-green-900/10">
                <p className="flex items-center gap-1.5 text-xs font-semibold text-green-800 dark:text-green-300"><Smartphone className="h-3.5 w-3.5" /> Pay with M-Pesa</p>
                <ol className="mt-2 space-y-1 text-xs text-navy-600 dark:text-navy-300">
