...
type DialogKind = null | "visitor" | "payment" | "inquiry" | "call" | "stkfees" | "report_day";
...
function PaymentDialog({ onClose, onSaved }: { onClose: () => void; onSaved: () => void }) {
  ...
  return (
    <Dialog title="Record walk-in payment" onClose={onClose} footer={
      ...
      {f.method === "mpesa" && (
        <Field label="M-Pesa reference"><Input value={f.mpesaRef} onChange={(e) => set("mpesaRef", e.target.value)} placeholder="e.g. SGH7XK9TQ2" /></Field>
      )}
